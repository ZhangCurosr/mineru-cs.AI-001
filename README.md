# 📄 arXiv 人工智能 (cs.AI) 论文库

每天自动抓取 arXiv cs.AI 分类的新论文，经 MinerU 解析后归档为完整可检索的论文笔记。

<!-- 胶囊徽章带：论文数 / 最近更新 / 流水线 / License -->
![Papers](https://img.shields.io/badge/Papers-113-brightgreen?style=flat-square)
![Last commit](https://img.shields.io/github/last-commit/ZhangCurosr/zhangcursor-papers-arxiv-ai-001?style=flat-square)
...
- **内容**：arXiv 人工智能（Artificial Intelligence, cs.AI）分类下每日新增的学术论文。
...
# 按标题搜索（示例）
git ls-remote https://github.com/ZhangCurosr/zhangcursor-papers-arxiv-ai-001.git
```
